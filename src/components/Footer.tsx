  ...
  return (
    <footer className="bg-verde text-cream">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Layout Mobile (2 colunas) e Desktop (3 colunas) */}
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 items-center">
          ...
          {/* Coluna 2: Contatos e Redes Sociais (mobile) / Contatos e Copyright (desktop) */}
          <div className="flex flex-col items-center gap-3">
            <div className="flex items-center gap-4 text-sm font-instrument">
              <a 
            ...
            {/* Redes Sociais - visible no mobile */}
          ...
          {/* Coluna 3: Redes Sociais (apenas desktop) */}
      ...
      <div className="w-full overflow-hidden">
        <Image
          ...
          width={1200}
          height={80}
          className="w-full h-16 sm:h-20 md:h-24 object-cover scale-125 sm:scale-100 sm:object-contain"
          priority={false}
        />
      </div>
    </footer>
