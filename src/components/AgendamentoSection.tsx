            ...
            <div className="flex flex-col lg:flex-row gap-8 lg:gap-12">
              ...
              <div className="hidden lg:block">
                <div className="sticky top-32 w-80 space-y-4">
                  {/* Aviso sobre pagamento - Desktop */}
                  <div className="bg-amarelo/10 border border-amarelo/30 rounded-xl p-4">
                    <div className="flex items-start gap-3">
                      <div className="flex-shrink-0 w-5 h-5 mt-0.5">
                        <svg className="w-full h-full text-amarelo" fill="currentColor" viewBox="0 0 24 24">
                      ...
                      <div className="flex-1">
                        <p className="text-cinza font-instrument text-xs leading-relaxed">
                          <strong className="font-semibold">Pagamento:</strong> Nossa equipe entrará em contato por WhatsApp para combinar.
                        </p>
                      </div>
                    </div>
                  </div>
