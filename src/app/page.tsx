      ...
      <footer className="bg-verde text-cream">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                <Image
                  ...
                  priority
                />
                <h3 className="text-xl font-instrument font-medium tracking-wide">
                  CASA ALVITE
                </h3>
              </div>
              <p className="text-cream/90 text-sm leading-relaxed font-instrument">
                Experiências únicas de cerâmica em um ambiente acolhedor. 
                Venha criar memórias especiais com quem você ama.
              </p>
            </div>

            {/* Contato */}
            <div className="space-y-4">
              <h4 className="text-lg font-instrument font-medium">
                Contato
              </h4>
              <div className="space-y-3 text-sm font-instrument">
                <div className="flex items-start gap-2">
                  <span className="text-amarelo">📍</span>
                  <div>
                    <p className="text-cream/90">Rio de Janeiro, RJ</p>
                  </div>
                </div>
                <div className="flex items-center gap-2">
                  ...
                  <a 
                    href="https://wa.me/5521991792065" 
                    className="text-cream/90 hover:text-amarelo transition-colors"
                    target="_blank"
                    rel="noopener noreferrer"
                  >
                    (21) 99179-2065
                ...
                <div className="flex items-center gap-2">
                  <span className="text-amarelo">📧</span>
                  <a 
                    href="mailto:contato@casaalvite.com" 
                    className="text-cream/90 hover:text-amarelo transition-colors"
                  >
                    contato@casaalvite.com
                  </a>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="flex gap-4">
                <a 
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="w-10 h-10 bg-cream/10 rounded-full flex items-center justify-center text-cream hover:bg-amarelo hover:text-verde transition-all duration-200"
                  title="WhatsApp"
                >
              ...
              <div className="pt-4 space-y-2 text-sm font-instrument">
                <div>
                  <strong className="text-amarelo">Horário de Funcionamento:</strong>
                </div>
          ...
          <div className="mt-8 pt-8 border-t border-cream/20">
            <div className="flex flex-col sm:flex-row justify-between items-center gap-4 text-sm font-instrument">
              <p className="text-cream/80">
                © 2025 Casa Alvite. Todos os direitos reservados.
              </p>
              <div className="flex gap-6">
                <a href="#" className="text-cream/80 hover:text-amarelo transition-colors">
