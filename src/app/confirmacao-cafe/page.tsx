              ...
              <div className="space-y-6">
                ...
                <div className="border-t border-cinza/10 pt-6">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-verde rounded-full"></div>
                      <span className="text-cinza/80 font-instrument text-sm">Pintura da sua cumbuca</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-verde rounded-full"></div>
                    ...
                    <div className="flex items-center gap-2">
                      <div className="w-2 h-2 bg-verde rounded-full"></div>
                      <span className="text-cinza/80 font-instrument text-sm">Buffet completo</span>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <div className="bg-amarelo/10 rounded-3xl p-6 border border-amarelo/20">
              ...
              <div className="space-y-3">
                <div className="flex items-start gap-3">
                  <div className="w-2 h-2 bg-verde rounded-full flex-shrink-0 mt-2"></div>
                  <p className="text-cinza font-instrument text-sm">
                    <strong>Entre em contato pelo WhatsApp</strong> para qualquer dúvida
                  </p>
                </div>
